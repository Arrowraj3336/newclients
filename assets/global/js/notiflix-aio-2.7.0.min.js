    ...
    var e, i, a, o, n, r = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation",
        ...
        B = function(a, o, n, r) {
            ...
            if ("object" == typeof o && !Array.isArray(o) || "object" == typeof n && !Array.isArray(n)) {
                var m = {};
                "object" == typeof o ? m = o : "object" == typeof n && (m = n), e = y(!0, e, m)
            }
            var p = e[r.toLocaleLowerCase("en")];
            A++, "function" == typeof o && X++, "string" != typeof a && (a = "Notiflix " + r), e.plainText && (a = k(a)), !e.plainText && a.length > e.messageMaxLength && (e = y(!0, e, {
                closeButton: !0,
            ...
            if (h) {
                ...
                var z, C, W = function() {
                        h.classList.add("remove"), e.backOverlay && 0 >= N.childElementCount && v.classList.add("remove"), clearTimeout(z)
                    },
                    S = function() {
                        h && null !== h.parentNode && h.parentNode.removeChild(h), 0 >= N.childElementCount && null !== N.parentNode && (N.parentNode.removeChild(N), e.backOverlay && null !== v.parentNode && v.parentNode.removeChild(v)), clearTimeout(C)
                    };
                ...
                if (("function" == typeof o || e.clickToClose) && h.addEventListener("click", function() {
                    ...
                    I(), e.pauseOnHover && (h.addEventListener("mouseenter", function() {
                        h.classList.add("nx-paused"), clearTimeout(z), clearTimeout(C)
        ...
        F = function(e, a, o, n, r, l) {
            ...
            if ("object" == typeof n && !Array.isArray(n) || "object" == typeof r && !Array.isArray(r)) {
                var p = {};
                "object" == typeof n ? p = n : "object" == typeof r && (p = r), m = y(!0, i, {}), i = y(!0, i, p)
            }
        ...
        E = function(e, i, o, n, r, l, c, p, f) {
            ...
            if (p && "string" == typeof f && 0 < f.length && (v = f, h = "<div><input id=\"NXConfirmValidationInput\" type=\"text\" style=\"font-size:" + a.messageFontSize + ";border-radius: " + a.borderRadius + ";\" maxlength=\"" + f.length + "\" autocomplete=\"off\" spellcheck=\"false\" autocapitalize=\"none\" /></div>"), x.innerHTML = u + "<div class=\"" + a.className + "-content\" style=\"width:" + a.width + "; background:" + a.backgroundColor + "; animation-duration:" + a.cssAnimationDuration + "ms; border-radius: " + a.borderRadius + ";\"><div class=\"" + a.className + "-head\"><h5 style=\"color:" + a.titleColor + ";font-size:" + a.titleFontSize + ";\">" + e + "</h5><div style=\"color:" + a.messageColor + ";font-size:" + a.messageFontSize + ";\">" + i + h + "</div></div><div class=\"" + a.className + "-buttons\"><a id=\"NXConfirmButtonOk\" class=\"confirm-button-ok" + ("function" == typeof r ? "" : " full") + "\" style=\"color:" + a.okButtonColor + ";background:" + a.okButtonBackground + ";font-size:" + a.buttonsFontSize + ";\">" + o + "</a>" + w + "</div></div>", !t.document.getElementById(x.id)) {
                ...
                if (C && (C.focus(), C.addEventListener("keyup", function(t) {
                        var e = (t.target.value || "").toString();
                        if (e !== v) C.classList.add("nx-validation-failure"), C.classList.remove("nx-validation-success");
                        else {
                            C.classList.remove("nx-validation-failure"), C.classList.add("nx-validation-success");
                        ...
                        if (p && v && C) {
                            ...
                            if (e !== v) return C.focus(), C.classList.add("nx-validation-failure"), t.stopPropagation(), t.preventDefault(), t.returnValue = !1, t.cancelBubble = !0, !1;
                            C.classList.remove("nx-validation-failure")
                        }
                        "function" == typeof r && r(), N.classList.add("remove");
                        var i = setTimeout(function() {
                            null !== N.parentNode && (N.parentNode.removeChild(N), clearTimeout(i))
        ...
        D = function(e, i, a, n, r) {
            ...
            if ("object" == typeof e && !Array.isArray(e) || "object" == typeof i && !Array.isArray(i)) {
                var c = {};
                "object" == typeof e ? c = e : "object" == typeof i && (c = i), o = y(!0, o, c)
            }
            var m = "";
            if ("string" == typeof e && 0 < e.length && (m = e), n) {
                m = m.toString().length > o.messageMaxLength ? k(m).toString().substring(0, o.messageMaxLength) + "..." : k(m).toString();
                var f = "";
                0 < m.length && (f = "<p id=\"" + o.messageID + "\" class=\"loading-message\" style=\"color:" + o.messageColor + ";font-size:" + o.messageFontSize + ";\">" + m + "</p>"), o.cssAnimation || (o.cssAnimationDuration = 0);
                var x = "";
                if ("standard" === a) x = C(o.svgSize, o.svgColor);
                    ...
                    if ("custom" === a && null == o.customSvgUrl) return d("Notiflix Error", "You have to set a static SVG url to \"customSvgUrl\" option to use Loading Custom."), !1;
            ...
            } else if (t.document.getElementById(p.ID)) var z = t.document.getElementById(p.ID),
            ...
            if (i)
                if (0 < e.length) {
                    ...
                    if (a) a.innerHTML = e;
                        ...
                        n.id = o.messageID, n.className = "loading-message new-loading-message", n.style.color = o.messageColor, n.style.fontSize = o.messageFontSize, n.innerHTML = e, i.appendChild(n)
                    }
                } else d("Notiflix Error", "Where is the new message?")
        },
        j = 0,
        O = function(e, a, o, r, l, c) {
            var m = "string" != typeof a || 1 > (a || "").length || 1 === (a || "").length && ("#" === (a || "")[0] || "." === (a || "")[0]);
            if (m) return d("Notiflix Error", "The selector parameter must be a String and matches a specified CSS selector(s)."), !1;
            var p = t.document.querySelectorAll(a);
            if (1 > p.length) return d("Notiflix Error", "You called the \"Notiflix.Block...\" function with \"" + a + "\" selector, but there is no such element(s) in the document."), !1;
            n || H.Block.Init({});
            var b = y(!0, n, {});
            if ("object" == typeof r && !Array.isArray(r) || "object" == typeof l && !Array.isArray(l)) {
                var u = {};
                "object" == typeof r ? u = r : "object" == typeof l && (u = l), n = y(!0, n, u)
            }
            var w = "";
            "string" == typeof r && 0 < r.length && (w = r), n.cssAnimation || (n.cssAnimationDuration = 0);
                ...
                for (var z = 0; z < N; z++) {
                    ...
                    if (1 > A.length) {
                        ...
                        var B = "<span class=\"" + h + "-icon\" style=\"width:" + n.svgSize + ";height:" + n.svgSize + ";\">" + X + "</span>",
                            F = "";
                        0 < w.length && (w = w.length > n.messageMaxLength ? k(w).substring(0, n.messageMaxLength) + "..." : k(w), F = "<span style=\"font-size:" + n.messageFontSize + ";color:" + n.messageColor + ";\" class=\"" + h + "-message\">" + w + "</span>"), j++;
                    ...
                    _ = setTimeout(function() {
                        for (var t, e = 0; e < N; e++) t = p[e], Z(t), A = t.querySelectorAll("[id^=" + f.ID + "]"), J(A);
                        clearTimeout(_)
                    }, c);
            n = y(!0, n, b)
        },
        H = {
            ...
            Report: {
                Init: function(t) {
                    i = y(!0, c, t), w(i.useGoogleFont, i.fontFamily), u()
                },
                Merge: function(t) {
            ...
            Confirm: {
                Init: function(t) {
                    a = y(!0, m, t), w(a.useGoogleFont, a.fontFamily), u()
                },
                Merge: function(t) {
